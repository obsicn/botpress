...
module.exports = (bp, app) => {
  ...
  app.secure('read', 'bot/content').get('/content/categories/items', async (req, res) => {
  ...
  app.secure('read', 'bot/content').get('/content/categories/items/count', async (req, res) => {
    res.send(await bp.contentManager.categoryItemsCount())
  })
